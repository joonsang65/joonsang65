...
<a href="https://github.com/joonsang65">
...
| **Azan**<br><sub>Team Project</sub> | 유학생의 학사·행정 정보 탐색을 지원하는 **개인화 RAG 서비스** | • 유학생 5명 인터뷰 및 웹사이트 15개 분석<br>• LangChain · pgvector 기반 RAG Pipeline 구현<br>• 사용자 프로필 기반 개인화 · Multi-turn 처리<br>• **MRR@5 0.731 · Hit Rate@5 75.0% · Evidence 97.5%** | `LangChain`<br>`Gemini`<br>`FastAPI`<br>`PostgreSQL`<br>`pgvector` |
